...
<div class="student-hero">
    ...
    <a href="{{ route('peminjaman.create') }}" class="btn btn-student"><i class="bi bi-plus-circle me-2"></i>Ajukan peminjaman</a>
</div>
...
<style>
    ...
    .btn-student { background: #fff; border: 0; border-radius: 11px; color: #3930ad; font-weight: 700; padding: .75rem 1rem; position: relative; z-index: 1; } .btn-student:hover { background: #f0efff; color: #282184; }
    .student-grid { display: grid; gap: 1rem; grid-template-columns: 1.25fr .75fr; margin-bottom: 2rem; } .student-card { background: #fff; border: 1px solid #e7ebf3; border-radius: 18px; box-shadow: 0 8px 24px rgba(31,41,65,.04); }
    ...
    @media (max-width: 767.98px) { .student-hero { align-items: flex-start; flex-direction: column; gap: 1.2rem; padding: 1.5rem; } .student-grid { grid-template-columns: 1fr; } .student-section-head { align-items: flex-start; flex-direction: column; gap: .5rem; } }
</style>
@endsection